...
//Secure parameter from SQL injection
                            if (isset($_GET["kode"])){
                                ...
                                $kodet = secureParam($_GET["kodet"], $dbLink);
                            }else{
                                $kode = "";
                            }
                            ...
                            $q.= "WHERE md5(t.no_transaksi)='".$kode."' and md5(t.kode_transaksi)='".$kodet."'";
