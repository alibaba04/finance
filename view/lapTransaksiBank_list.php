...
$curPage = "view/lapTransaksiBank_list";
...
<section class="content-header">
    <h1>
        ...
        <small>List Transaksi Bank</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Output</li>
        <li class="active">Laporan Transaksi Bank</li>
    </ol>
</section>
<!-- Main content -->
        ...
        <section class="col-lg-6">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Kriteria Pencarian Transaksi Bank </h3>
                </div>
                <form name="frmCariJurnal" method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Range Tanggal Transaksi Bank </label>
...
//Paging
                ?>
                <div class="box-header">
                    <i class="ion ion-clipboard"></i>&nbsp;&nbsp;Data Transaksi Bank <?php if (!empty($tglJurnal1)){ echo " dari tanggal ". $tglJurnal1 . " sampai dengan tanggal ". $tglJurnal2; } ?> 
                    <!-- <a href="pdf/pdf_lapbank.php?&tglJurnal1=<?=$tglJurnal1; ?>&tglJurnal2=<?=$tglJurnal2; ?>" title="Cetak PDF Transaksi Bank"><button type="button" class="btn btn-info pull-right"><i class="fa fa-print "></i> Cetak Transaksi Bank</button></a>&nbsp;&nbsp; -->
                    <a href="excel/c_exportexcel_lbank.php?&tglJurnal1=<?=$tglJurnal1; ?>&tglJurnal2=<?=$tglJurnal2; ?>"><button class="btn btn-info pull-right"><i class="ion ion-ios-download"></i> Export Excel</button></a>
