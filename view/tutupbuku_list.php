...
if (substr($_SERVER['PHP_SELF'], -10, 10) == "index2.php" && $hakUser == 90) {
    require_once("./class/c_tutupbuku.php");
    $tmpRLNeraca = new c_tutupbuku;
//Jika Mode Tambah/Add
    if ($_POST["sbmHitungRL"] == "Proses Hitung") {
        $tglPosting1 = $_POST['starts'];
        $tglPosting2 = $_POST['ends'];
        $pesan = $tmpRLNeraca->tutupbuku($tglPosting1,$tglPosting2);
    }
        ...
        <section class="col-lg-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form name="frmProsesRL" method="POST" action="index2.php?page=view/tutupbuku_list" onSubmit="return validate(this);">
